...
* **Bandwidth Limitation & Stability ($R_f \vert{}\vert{} C_f$ Network):** Large feedback resistors create high gain but introduce instability and high-frequency noise susceptibility. To combat this, we placed a feedback capacitor ($C_f = 0.1\,\mu\text{F}$) in parallel with $R_f$. This creates a first-order low-pass filter with a cutoff frequency
